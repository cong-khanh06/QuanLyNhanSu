...
CREATE TABLE quanlynhansu.dbo.LoaiBaoHiem (
	...
	ty_le_nv_dong decimal(5,2) NULL,
	ty_le_cty_dong decimal(5,2) NULL,
...
-- quanlynhansu.dbo.ChiTietChucVu definition

-- Drop table

-- DROP TABLE quanlynhansu.dbo.ChiTietChucVu;

CREATE TABLE quanlynhansu.dbo.ChiTietChucVu (
	ma_cv varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	ma_pc varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	CONSTRAINT PK_ChiTietChucVu PRIMARY KEY (ma_cv,ma_pc),
	CONSTRAINT FK_ChiTietChucVu_ChucVu FOREIGN KEY (ma_cv) REFERENCES quanlynhansu.dbo.ChucVu(ma_cv),
	CONSTRAINT FK_ChiTietChucVu_PhuCap FOREIGN KEY (ma_pc) REFERENCES quanlynhansu.dbo.PhuCap(ma_pc)
);
...
CREATE TABLE quanlynhansu.dbo.DuAn (
	...
	trang_thai nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	nguoi_quan_ly varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
ALTER TABLE quanlynhansu.dbo.NhanVien WITH NOCHECK ADD CONSTRAINT CHK_GioiTinh CHECK (([gioi_tinh]=N'Nam' OR [gioi_tinh]=N'Nu'));
...
CREATE TABLE quanlynhansu.dbo.PhongBan (
	...
	ma_tp varchar(20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
-- quanlynhansu.dbo.BangCap foreign keys

ALTER TABLE quanlynhansu.dbo.BangCap ADD CONSTRAINT FK__BangCap__ma_nv__4F7CD00D FOREIGN KEY (ma_nv) REFERENCES quanlynhansu.dbo.NhanVien(ma_nv);


-- quanlynhansu.dbo.BangChamCong foreign keys

ALTER TABLE quanlynhansu.dbo.BangChamCong ADD CONSTRAINT FK__BangChamC__ma_nv__74AE54BC FOREIGN KEY (ma_nv) REFERENCES quanlynhansu.dbo.NhanVien(ma_nv);


-- quanlynhansu.dbo.BangLuong foreign keys

ALTER TABLE quanlynhansu.dbo.BangLuong ADD CONSTRAINT FK__BangLuong__ma_nv__797309D9 FOREIGN KEY (ma_nv) REFERENCES quanlynhansu.dbo.NhanVien(ma_nv);


-- quanlynhansu.dbo.ChiTietBaoHiem foreign keys

ALTER TABLE quanlynhansu.dbo.ChiTietBaoHiem ADD CONSTRAINT FK__ChiTietBa__ma_bh__59063A47 FOREIGN KEY (ma_bh) REFERENCES quanlynhansu.dbo.LoaiBaoHiem(ma_bh);
...
ALTER TABLE quanlynhansu.dbo.NhanVien ADD CONSTRAINT FK__NhanVien__ma_cv__44FF419A FOREIGN KEY (ma_cv) REFERENCES quanlynhansu.dbo.ChucVu(ma_cv);
ALTER TABLE quanlynhansu.dbo.NhanVien ADD CONSTRAINT FK__NhanVien__ma_pb__440B1D61 FOREIGN KEY (ma_pb) REFERENCES quanlynhansu.dbo.PhongBan(ma_pb);


-- quanlynhansu.dbo.PhanCongDuAn foreign keys

ALTER TABLE quanlynhansu.dbo.PhanCongDuAn ADD CONSTRAINT FK_PCDA_DuAn FOREIGN KEY (ma_da) REFERENCES quanlynhansu.dbo.DuAn(ma_da);
ALTER TABLE quanlynhansu.dbo.PhanCongDuAn ADD CONSTRAINT FK_PCDA_NguoiThamGia FOREIGN KEY (ma_nv) REFERENCES quanlynhansu.dbo.NhanVien(ma_nv);


-- quanlynhansu.dbo.PhongBan foreign keys

ALTER TABLE quanlynhansu.dbo.PhongBan ADD CONSTRAINT FK_PhongBan_NhanVien_MaTP FOREIGN KEY (ma_tp) REFERENCES quanlynhansu.dbo.NhanVien(ma_nv);
ALTER TABLE quanlynhansu.dbo.PhongBan ADD CONSTRAINT FK__PhongBan__ma_bp__398D8EEE FOREIGN KEY (ma_bp) REFERENCES quanlynhansu.dbo.BoPhan(ma_bp);
...
ALTER TABLE quanlynhansu.dbo.UngLuong ADD CONSTRAINT FK_UngLuong_BangLuong FOREIGN KEY (ma_bl) REFERENCES quanlynhansu.dbo.BangLuong(ma_bl);